---
description: "The TypeScript SDK client for callers that spawn a Harness runtime subprocess and drive agent turns over stdio JSON-RPC: the DeepSeekHarness run API and the lower-level HarnessClient."
